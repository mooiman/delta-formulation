...
%
\begin{align}
    \widetilde u - \pdiff{}{x} \left( \Psi \pdiff{\widetilde u}{x} \right) = u_{\mathit{giv}},
...
\begin{align}
    ...
    c_{E} = c_\Psi \frac{1}{(k\Dx)^2}\frac{\pi}{2} = c_\Psi^2 \frac{\pi}{2}
\end{align}
where \autoref{eq:c_psi_kdx_squared} is used.
...
\begin{align}
    c_E = c_\Psi \frac{1}{(k\Dx)^2}\frac{\pi}{2}
    \quad \Rightarrow \quad
    c_{E} \approx 27.2708
\end{align}
%
