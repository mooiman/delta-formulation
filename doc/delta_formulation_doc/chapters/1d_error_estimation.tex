...
= E
\end{align}
for constant $\Dx$, constant $c_E$ and constant $\Psi$, and
\begin{align}
    E = D^{u,x}_{\xi} = \Dx^2 \pdiff[2]{u}{x}
\end{align}
In physical space this equation reads ($\Psi = c_E \Dx^2 E$):
\begin{align}
    \widetilde{E} - \Dx^2 \pdiff{}{x}\left(c_\Psi \pdiff{\widetilde{E}}{x}\right)
