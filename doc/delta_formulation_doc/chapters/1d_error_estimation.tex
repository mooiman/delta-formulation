...
The Fourier-mode transform of \autoref{eq:1d_regularization} reads, when $\Dx = \mathit{constant}$ and $\Psi = c_{\Psi} \Dx^2 = \mathit{constant}$:
\begin{align}
...
%-------------------------------------------------------------------------------
\section{Determining the factor ${c_{\Psi}}$}\label{sec:determine_factor_c_psi}
...
%--------------------------------------------------------------------------------
\section{$L^1$-norm for the functions $\widetilde{u}$, $\overline{u}$ and $u_{\mathit given}$}
