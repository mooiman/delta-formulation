...
\begin{longtable}{|>{\bfseries}p{6mm-12pt}|p{\textwidth/4-6mm-12pt}|p{\textwidth/4-0mm-12pt}|p{\textwidth/4-0mm-12pt}|p{\textwidth/4-0mm-12pt}|}
...
\bottomline
\endlastfoot
1 & 5\ \%   &  1.20 & 0.8333  ($\approx$ 1)&  1.0908 ($\approx$ 1) \\
\midline
2 & 2\ \%  & 0.48 & 2.0833 ($\approx$ 2)   &  6.8177 ($\approx$ 10)\\
\midline
\rowcolor{mgreen2}
3 & 1\ \%  & 0.24 &  4.1667 ($\approx 4$)   & 27.2708 ($\approx$ 32) \\
\midline
4 & 0.5\ \% & 0.12 & 8.3333 ($\approx$ 8)  &  109.0831 ($\approx$ 110)\\
\end{longtable}
%--- end light blue table ---
%
%
