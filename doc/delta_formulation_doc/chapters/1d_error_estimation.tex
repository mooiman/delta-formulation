...
\midline
\rowcolor{mgreen2} 3 & 1\ \%  &  4.1666 ($\approx$ 4)   & 12.8254 \\
\midline
...
For a $1$~\% accuracy, see \autoref{tab:numerical_accuracy}, the maximum allowed Fourier modes is $k\Dx < 0.4899$, substitution yields:
\begin{align}
    c_\Psi \approx 4 = c_{E} (0.4899)^2 \frac{2}{\pi}  \quad \Rightarrow \quad c_{E} \approx 26.1797
\end{align}
