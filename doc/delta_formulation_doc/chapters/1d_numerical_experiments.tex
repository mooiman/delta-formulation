...
\end{symbollist}
%--------------------------------------------------------------------------------
\subsection{Linear initial condition, standing shock wave}
The linear initial condition has no numerical error because it is a second order method and the boundary conditions are chosen to generate a standing shock wave at the middle of the domain.
%--------------------------------------------------------------------------------
\paragraph*{Numerical experiment}
The numerical experiment is performed with the following parameters:
\begin{itemize}
    ...
    \item Prescribed velocity on boundary at $x=0$ is given by $u(0,t) = \bqty{1}{\metre\per\second}$ and $x=L_x$ by $u(L_x,t) = \bqty{-1}{\metre\per\second}$.
...
The results are stationary over the time interval $t\in[4, 6]$ hour.
\begin{figure}[H]
        \centering
        \includegraphics[width=0.9\textwidth]{figures/standing_shock_wave_time_series.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/standing_shock_wave_time_series_dt60_dt30_dt15.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/standing_shock_wave_velocity.png}
    \caption{Shock wave around $x=\bqty{10000}{\metre}$ for simulations with:
        black line $\Dx =\bqty{5}{\metre}, \Dt=\bqty{1}{\second}$;
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/standing_shock_wave_psi.png}
