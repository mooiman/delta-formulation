...
\end{symbollist}
First the discretization of \autoref{eq:regularization_2d} is discussed and second the determination of the artificial smoothing coefficient $\bPsi$.
...
\end{symbollist}
%--------------------------------------------------------------------------------
\section{Discretization} % of \autoref{eq:regularization_2d}}
...
The artificial smoothing coefficient (\autoref{eq:regularization_2d}) is dependent on the second derivative of given function $u_{giv}$ \citep[eq.\ 8]{Borsboom1998}.
...
\begin{align}
    ...
    \label{eq:error_regularization_2d}
\end{align}
...
Now system \autoref{eq:error_regularization_2d} can be solved and $\bPsi$ is set to:
\begin{align}
