...
+ \underbrace{\left(- \nu_{qp} \frac{1}{h^{n+\theta,p}_{qp}}  \pdiff{h^{n+\theta,p}_{qp}}{x}\right)}_{{\cal{B}}_1} \theta \Delta q_{qp}
    ...
    \underbrace{\nu_{qp} \frac{q^{n+\theta,p}_{qp}}{h^{n+\theta,p}_{qp}}}_{{\cal{D}}_1} \pdiff{}{x}(\theta \Delta h_{qp})
\end{align}
...
\underbrace{\nu_{qp} \frac{q^{n+\theta,p}_{qp}}{h^{n+\theta,p}_{qp}}}_{{\cal{D}}_2} \pdiff{}{y}(\theta \Delta h_{qp})
\end{align}
and
\begin{align}
...
\underbrace{\nu_{qp} \frac{r^{n+\theta,p}_{qp}}{h^{n+\theta,p}_{qp}}}_{{\cal{D}}_3} \pdiff{}{x}(\theta \Delta h_{qp})
\end{align}
and
\begin{align}
...
\underbrace{\nu_{qp} \frac{r^{n+\theta,p}_{qp}}{h^{n+\theta,p}_{qp}}}_{{\cal{D}}_4} \pdiff{}{y}(\theta \Delta h_{qp})
\end{align}
