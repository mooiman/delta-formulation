...
\begin{figure}[H]
    ...
    \end{center}
    \caption{Coefficients for the mass-matrix and the control volume in 2-dimensions, on a structured grid. The white circles indicate the location of the quadrature points, and white diamonds the flux points.}
