...
To avoid the discontinuity in the first derivative around zero for the absolute function this function will be approximated by (the Newton iteration process needs continue functions)
\begin{align}
