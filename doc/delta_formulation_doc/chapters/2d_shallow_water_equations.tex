...
-x_\eta & x_\xi
\end{pmatrix}
= J \mat{\eqref{eq:inverse_transformation}}
\end{align}
...
\begin{align}
    F_q = J\int_{\Omega_{\xi\eta}} c_f \left( \frac{q\abs{\vec{q}}}{h^2} \right)\, d\omega, \qquad \textit{q-momentum eq.}
    \\
    F_r = J\int_{\Omega_{\xi\eta}} \left( \frac{r\abs{\vec{q}}}{h^2} \right)\, d\omega, \qquad \textit{r-momentum eq.}
\end{align}
...
\begin{align}
    F_q &\approx J\, c_f \left( \frac{q\abs{\widetilde{\vec{q}}}}{h^2} \right), \qquad \textit{q-momentum eq.}
    \\
    F_r &\approx J\, c_f \left( \frac{r\abs{\widetilde{\vec{q}}}}{h^2} \right), \qquad \textit{r-momentum eq.}
\end{align}
