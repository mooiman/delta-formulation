...
On a cartesian grid ($ y_\xi = x_\eta = 0$) these viscous terms  reduce for the $x$-momentum (\autoref{eq:xi_greens_viscous_term}) equation to:
\begin{align}
     \Bigg[& \frac{\nu}{J} \bigg(
    - 2 y_{\eta}  y_{\eta} \left(\pdiff{q}{\xi} - \frac{q}{h}\pdiff{h}{\xi} \right)
     \bigg) \Bigg] \nxi +
...
\end{align}
and for the $y$-momentum (\autoref{eq:eta_greens_viscous_term}) to:
\begin{align}
    \Bigg[&\frac{\nu}{J} \bigg(
    - y_{\eta} y_{\eta} \left(\pdiff{r}{\xi} - \frac{r}{h}\pdiff{h}{\xi} \right)
