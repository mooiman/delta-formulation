...
\begin{align}
    ...
    +
    \\
    + \Bigg[ & \frac{\nu}{J} \bigg( y_{\xi} y_{\eta} \left(\pdiff{r}{\xi} - \frac{r}{h}\pdiff{h}{\xi} \right)
...
On a cartesian grid ($ y_\xi = x_\eta = 0$) these viscous terms (\autoref{eq:xi_greens_viscous_term} and \eqref{eq:eta_greens_viscous_term}) reduce for the $x$-momentum equation to:
\begin{align}
    - \Bigg[& \frac{\nu}{J} \bigg(
    2 y_{\eta}  y_{\eta} \left(\pdiff{q}{\xi} - \frac{q}{h}\pdiff{h}{\xi} \right)
     \bigg) \Bigg] \nxi +
...
\begin{align}
    ...
    %
    \\*
    & + \underbrace{ \frac{q^{n+\theta,p}}{(h^{n+\theta,p})^2} \pdiff{h^{n+\theta,p}}{\xi}}_{{\cal{A}}_1} \theta \Delta h
    + \underbrace{\left(-\frac{1}{h^{n+\theta,p}}  \pdiff{h^{n+\theta,p}}{\xi}\right)}_{{\cal{B}}_1} \theta \Delta q
    \\*
    & +
    \underbrace{1}_{{\cal{C}}_1} \pdiff{}{\xi}(\theta \Delta q) +
    \underbrace{\left(-\frac{q^{n+\theta,p}}{h^{n+\theta,p}}\right)}_{{\cal{D}}_1}
...
\end{align}
    ...
    \item
    \begin{align}
        &\pdiff{r}{\xi} - \frac{r}{h}\pdiff{h}{\xi}
        \\
    \end{align}
    \item
    \begin{align}
        &\pdiff{r}{\eta} - \frac{r}{h}\pdiff{h}{\eta}
    \end{align}
\end{enumerate}
%-------------------------------------------------------------------------------
