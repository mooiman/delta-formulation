...
\begin{align}
    ...
    \end{pmatrix}
\end{align}
with $\Psi_{11}$ and $\Psi_{22}$ are the added artificial viscosity due to the regularization of the primairy variables (see \autoref{sec:artificial_viscosity}), for the $q$-equation it yields
%
\begin{align}
    \Bigg[ &  \frac{\nu_{11}}{J} \left(
    - 2 y_{\eta} y_{\eta} h \pdiff{(q/h)}{\xi}
