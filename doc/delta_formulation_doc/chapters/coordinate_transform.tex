...
\begin{align}
    \frac{1}{J}\oint_{\partial\Omega_{\xi\eta}} \left( \left( y_{\eta}\frac{q^2}{h} - x_{\eta} \frac{qr}{h} \right) n_\xi + \left(-y_{\xi} \frac{q^2}{h} + x_{\xi} \frac{qr}{h} \right) n_\eta \right)\, dl.
\end{align}
which is equal to (and look to the similarity with \autoref{eq:transformed_mass_flux})
\begin{align}
    \frac{1}{J}\oint_{\partial\Omega_{\xi\eta}} \left[  \left( y_{\eta}q - x_{\eta} r \right) \frac{q}{h}  n_\xi + \left( -y_{\xi}q  + x_{\xi}r\right) \frac{q}{h} n_\eta \right] \, dl.\label{eq:transformed_convection_x}
\end{align}
