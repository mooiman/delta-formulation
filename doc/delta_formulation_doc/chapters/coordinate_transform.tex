...
\begin{align}
    ...
    \, d\omega
\end{align}
For the $q$-momentum equation the viscous terms (just looking to the term within the integral) read:
	\begin{align}
		\begin{aligned}
...
The viscous terms for the $q$-equation can be transformed as follows:
\newline
    \textit{step 1}
	\begin{align}
		\begin{aligned}
...
\begin{align}
    ...
    - x_{\xi}y_{\eta} \left(\pdiff{r}{\xi} - \frac{r}{h}\pdiff{h}{\xi} \right)
    - x_{\xi}x_{\xi} \left(\pdiff{q}{\eta} - \frac{q}{h}\pdiff{h}{\eta} \right) \bigg) \Bigg] \neta
    \label{eq:cart_xi_viscous_term_app}
\end{align}
...
\begin{align}
 ...
 - 2 x_{\xi}x_{\xi} \left(\pdiff{r}{\eta} - \frac{r}{h}\pdiff{h}{\eta} \right) \bigg) \Bigg] \neta
    \label{eq:cart_eta_viscous_term_app}
\end{align}
