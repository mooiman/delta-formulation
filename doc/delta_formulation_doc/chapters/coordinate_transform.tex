...
\end{align}
For the $x$-momentum equation the viscous terms
	\begin{align}
		\begin{aligned}
...
\begin{align}
    ...
    + x_{\xi}x_{\xi} \pdiff{(q/h)}{\eta} \bigg) \Bigg] \neta
\end{align}
Written as linear combination of the first derivative yields:
\begin{align}
    - \Bigg[& \frac{\nu}{J} \bigg(
...
\begin{align}
    ...
    +
    \\
    + \Bigg[ & \frac{\nu h}{J} \bigg( y_{\xi} y_{\eta} \left(\pdiff{r}{\xi} - \frac{r}{h}\pdiff{h}{\xi} \right)
