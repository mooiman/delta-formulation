...
\end{align}
The error function for artificial viscosity  ${\mathit Err}_\Psi$ reads (comparable with \citet[eq.\ 42]{Borsboom2001}, differs by a factor of $1/8$):
\begin{align}
...
\begin{align}
    ...
    = 0
\end{align}
the energy equation reads (\autoref{sec:obtaining_2denergy_equation}):
\begin{align}
...
\begin{align}
    {\mathit Err}&\left( \sqrt{\half \left( \frac{\widehat{q}^2}{\widehat{h}^2} + \frac{\widehat{r}^2}{\widehat{h}^2} \right)} \right) =
    \\*
    & =
