...
\end{align}
With energy conservation ($\lpdiff{}{t} = 0$) and $q=\textit{Constant}$, when have:
\begin{align}
...
%--------------------------------------------------------------------------------
\subsection{1D Error function $\mathit{Err}_\psi$} \label{sec:err_psi_1d}
...
\begin{align}
    ...
    \\
    & \approx \sqrt{g\left(\hhat + \frac{1}{8}\Dx^2\pdiff[2]{\hhat}{x}\right)} - \sqrt{g\hbar} \approx
    \\
    & \approx \sqrt{g\hbar\left(1 + \frac{1}{8\hbar}\Dx^2\pdiff[2]{\hbar}{x}\right)} - \sqrt{g\hbar} \approx
    \\
...
\begin{align}
    {\mathit Err}\left( \half\sqrt{2}\frac{\qhat}{\hhat} \right) & =  \half\sqrt{2}\left(\frac{\qhat}{\hhat} - \frac{\qbar}{\hbar} \right)
    \approx
    \half\sqrt{2} \left( \frac{\qbar + \frac{1}{8}\Dx^2\pdiff[2]{\qbar}{x}}{\hbar + \frac{1}{8}\Dx^2\pdiff[2]{\hbar}{x}} - \frac{\qbar}{\hbar} \right) \approx
    \\
    & \approx \half\sqrt{2} \left( \frac{\qbar}{\hbar}\frac{1 + \frac{1}{8}\Dx^2\frac{1}{\qbar}\pdiff[2]{\qbar}{x}}{1+\frac{1}{8}\Dx^2\frac{1}{\hbar}\pdiff[2]{\hbar}{x}} - \frac{\qbar}{\hbar} \right) \approx
    \\
...
\begin{align}
    ...
    \right] = 0
\end{align}
With energy conservation  ($\lpdiff{}{t}=0$) and $q = \textit{Constant}$, $r = \textit{Constant}$ it yields:
\begin{align}
    \pdiff{}{x}
    \left( \half \left( \frac{q^2}{h^2}  + \frac{r^2}{h^2}  \right)
    + g \zeta \right)
    + \pdiff{}{y}
    \left( \half \left( \frac{q^2}{h^2} + \frac{r^2}{h^2} \right)
    + g \zeta \right) = 0
...
\begin{align}
    \mathit{Err}_{\psi} &=
    \mathit{Err} \left( \sqrt{g h} \right)
    + \mathit{Err} \left( \sqrt{ \half \left( \frac{q^2}{h^2} + \frac{r^2}{h^2} \right) } \right)
    \\
    & \leq
    \mathit{Err} \left( \sqrt{g h} \right)
...
\begin{align}
    ...
    & \approx \sqrt{g
        \left(\hhat +
        \half
        \left( \frac{\Dx}{2} \right)^2 \pdiff[2]{\hhat}{x}
        + \frac{\Dx}{2} \frac{\Dy}{2}  \frac{\partial\kern 0.083333em^2 \hhat}{\partial x \partial y}
        + \half \left( \frac{\Dy}{2} \right)^2 \pdiff[2]{\hhat}{y}
        \right)
    }
    - \sqrt{g\hbar} \approx
    \\
    & \approx \sqrt{g\hbar\left(1 + \frac{1}{8\hbar}\Dx^2\pdiff[2]{\hbar}{x} +
...
\begin{align}
{\mathit Err} \left( \sqrt{\half \frac{\widehat{q}^2}{\widehat{h}^2}}
+ \sqrt{\half \frac{\widehat{r}^2}{\widehat{h}^2}} \right) \leq
...
\begin{align}
    ...
    & \approx
    \half\sqrt{2} \left(
    \frac{\qhat + \half\left(\frac{\Dx}{2}\right)^2\pdiff[2]{\qhat}{x}
        +  \frac{\Dx}{2} \frac{\Dy}{2} \frac{\partial\kern 0.083333em ^2 \qhat}{\partial x \partial y}
        + \half\left(\frac{\Dy}{2}\right)^2\pdiff[2]{\qhat}{y}}
    {\hhat + \half\left(\frac{\Dx}{2}\right)^2\pdiff[2]{\hhat}{x}
        +  \frac{\Dx}{2} \frac{\Dy}{2}
        \frac{\partial\kern 0.083333em ^2 \hhat}{\partial x \partial y}
        + \half\left(\frac{\Dy}{2}\right)^2\pdiff[2]{\hhat}{y}}
...
With energy conservation  ($\lpdiff{}{t}=0$) and  $q=\textit{Constant}$ and $r=\textit{Constant}$):
\begin{align}
    &\pdiff{}{x}
    \left( \half \left( \frac{q^2}{h^2}  + \frac{r^2}{h^2}  \right)
    + g \zeta \right)
