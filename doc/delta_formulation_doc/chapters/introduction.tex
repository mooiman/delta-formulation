...
In \autoref{sec:1d_non_linear_wave_equation}: \nameref{sec:1d_non_linear_wave_equation}, the fully implicit time integration is presented for the non-linear wave equations.
