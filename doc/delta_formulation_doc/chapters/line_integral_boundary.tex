...
%--------------------------------------------------------------------------------
Consider the line integral needed along the boundary, ex.\ for a left/west boundary we have $\xi = \it{Constant}$.
\begin{align}
...
\end{align}
with the parametrization of the curve is given for $\paramt \in [0,1]$.

\paragraph*{Essential and natural boundary location}
The essential boundary is located at a location in the control volume $0\leq\xi\leq 1$ (see \autoref{fig:structured_grid_along_straight_boundary}, where $\xi \approx \frac{1}{3}$) and the natural boundary is located at the middle of an element (i.e.\ edge of a sub-control volume).
