...
The essential boundary is located at a location in the control volume $0\leq\xi\leq 1$ (see \autoref{fig:structured_grid_along_straight_boundary}, where $\xi \approx \frac{1}{3}$) and the natural boundary is located at the middle of an element (edge of a subcontrol volume.

In the remainder of this section we will focus on the right/west boundary of a control volume (i.e.\ natural boundary).
...
%    = \int^{\paramt_1}_{\paramt_0} \pdiff{h}{t} \sqrt{g_{\eta\eta} \left(\half\right)^2} \, d\paramt
    = \half \sqrt{g_{\eta\eta} \left(\half\right)^2} \, \pdiff{h}{t}
    = \half \sqrt{g_{\eta\eta}} \pdiff{h}{t}
\end{align}
and it will be approximated by, each item evaluated at the quadrature point $(i-\half, j-\quart)$:
\begin{align}
...
\begin{align}
    ...
    \int^{\paramt_1}_{\paramt_0} \pdiff{q}{x} ds \, d\paramt  =
    \half \sqrt{g_{\eta\eta}} \pdiff{q}{x}
\end{align}
...
\end{align}
and for the second term at the right hand side, yields, each item evaluated at the quadrature point $(i-\half, j-\quart)$:
\begin{align}
