...
%--------------------------------------------------------------------------------
\section{Viscosity term, 1D}\label{sec:linearisation_viscosity}
...
\end{align}
Linearization of the viscosity term at $x_{i+\half}$ reads, where $\Delta h^{n+1, p+1} = \Delta h$ and  $\Delta q^{n+1, p+1} = \Delta q$:
\begin{align}
