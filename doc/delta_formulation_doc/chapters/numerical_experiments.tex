...
\end{align}
%--------------------------------------------------------------------------------
\subsection{Transport of constant constituent} \label{sec:numerical_experiment_1dadv_constant_boundary}
...
with
\begin{symbollist}
    \item[$x_{\it cent}$] Location of the centre of the envelope, \bqty{2500}{\metre}
    \item[$L_{\it env}$] Length of the envelope, \bqty{2500}{\metre}
