...
\begin{align}
    ...
    & = -\left\{ \Dx \Dt_{inv} \left( \frac{1}{8}\left( c^{n+1,p}_{i-1} - c^{n}_{i-1} \right) + \frac{6}{8}\left( c^{n+1,p}_{i} - c^{n}_{i} \right) + \frac{1}{8}\left( c^{n+1,p}_{i+1} - c^{n}_{i+1} \right)\right) + \right.
    \nonumber \\*
    & \qquad + \half u \left((c^{n+1, p}_{i} + c^{n+1,p}_{i+1}) -  (c^{n+1, p}_{i-1} +c^{n+1,p}_{i}) \right) +
    \nonumber \\*
    &\qquad - \left. \left( \eps_{i+\half} \frac{c^{n+1,p}_{i+1} - c^{n+1,p}_{i}}{\Dx} - \eps_{i-\half} \frac{c^{n+1,p}_{i} - c^{n+1,p}_{i-1}}{\Dx}\right) \right\}
\end{align}
