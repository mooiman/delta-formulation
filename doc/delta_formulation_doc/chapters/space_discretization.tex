...
%        }
%    \end{center}
%    \caption{Quadratic function approximated with 1-point Gauss.} \label{fig:1d_integration_1points_gauss}
%    \end{subfigure}
%\hfill
%    \begin{subfigure}{0.475\textwidth}
%    \begin{center}
...
%        }
%    \end{center}
%    \caption{Quadratic function approximated with 2-point Gauss.} \label{fig:1d_integration_2points_gauss}
%    \end{subfigure}
