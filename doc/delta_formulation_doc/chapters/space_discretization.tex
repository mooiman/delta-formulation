...
\begin{figure}[H]
        ...
        \end{center}
    \caption{Integration of a quadratic function at $x_i$ over the control volume from $x_{i-\half}$ to $x_{i+\half}$ with the 1 point Gauss approximation, with 2 point Guass it is exact.}\label{fig:1d_integration_1points_gauss}
\end{figure}
...
%        }
%    \end{center}
%    \caption{Approximated with 1 point Gauss (piecewise linear). Thicker black line.} \label{fig:1d_integration_1points_gauss}
%    \end{subfigure}
%%
%    \begin{subfigure}{0.5\textwidth}
%    \begin{center}
...
%        }
%    \end{center}
%    \caption{Approximated with 2 point Gauss (quadratic). Thicker black line.} \label{fig:1d_integration_2points_gauss}
%    \end{subfigure}
%    \caption{Integration of a function (cyan line) over the control volume  $[x_{i-\half}, x_{i+\half}]$. Thicker and thinner black lines are given to show the difference between the two approximations. \newline
%    Black dots: Node values of the function.\newline
