...
\end{align}
with $\Dt_{\mathit{inv}} = 1/\Dt$, $\mat{M}$ a mass-matrix and $0 \leq \theta \leq 1$.
...
As example we take the finite volume approach of the two dimensional non-linear wave equation.
This equation reads:
%
\begin{align}
...
\begin{align}
    ...
    \label{eq:2d_convection_equation}
\end{align}
