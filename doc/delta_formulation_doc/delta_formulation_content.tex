...
\renewcommand{\vec}[1]{ \mbox{\boldmath $\underline{#1}$} }
\sisetup{mode=math}
...
\newcommand{\Dtinv}{\Delta t_{\mathit{inv}}}
\newcommand{\Jinv}{\frac{1}{J}}
\newcommand{\Du}{\Delta u}
\newcommand{\vecn}{\scalebox{1.1}{$\mathbcal{\underline{n}}$}}  % normal component in eta-direction
\newcommand{\nx}{\scalebox{1.1}{$\mathcal{n}_x$}}  % normal component in x-direction
\newcommand{\ny}{\scalebox{1.1}{$\mathcal{n}_y$}}  % normal component in y-direction
\newcommand{\nxi}{\scalebox{1.1}{$\mathcal{n}_\xi$}}  % normal component in xi-direction
\newcommand{\neta}{\scalebox{1.1}{$\mathcal{n}_\eta$}}  % normal component in eta-direction

\newcommand{\mat}[1]{\mbox{\boldmath ${\mathrm{#1}}$} }
\newcommand{\half}{\frac{1}{2}}
\newcommand{\quart}{\frac{1}{4}}
\newcommand{\abs}[1]{\left\lvert #1 \right\rvert}
\newcommand{\Fabs}[1]{F_{\mathit abs}(#1)\xspace}  % Continue function for the absolute value
...
\newcommand{\paramt}{\textbf{\textit{t}}}  % needed for the parameter of the line integral
...
\nomenclature{\rule{\linewidth}{0.5pt}}{\rule{\linewidth}{0.5pt}}{\rule{\linewidth}{0.5pt}}{}{}
\nomenclature[AG]{$u$}{\si{*}}{Non-regularized/non-smoothed function, to be determined numerically.}
\nomenclature[AG]{$\widetilde u$}{\si{*}}{Regularized/smoothed function, denoted by the wavy line.}
\nomenclature[AG]{$\overline u$}{\si{*}}{Piecewise linear function, denoted by the bar.}
\nomenclature[AG]{$\widehat u$}{\si{*}}{$C^{\infty}$-function of the equivalent problem.}
\nomenclature[AG]{$u_{i}$}{\si{*}}{Numerical solution at the nodes.}
...
%--------------------------------------------------------------------------------
\part{1D Equations}
\input{chapters/1d_shallow_water_equations.tex}
\input{chapters/1d_numerical_experiments.tex}
%--------------------------------------------------------------------------------
\part{2D Equations}
\input{chapters/2d_shallow_water_equations.tex}
\input{chapters/2d_numerical_experiments.tex}
%--------------------------------------------------------------------------------
...
\part{Appendices}
\appendix
\input{chapters/coordinate_transform.tex}
\input{chapters/1d_error_estimation.tex}
\input{chapters/1d_diagonalise_swe}
\input{chapters/error_function_artificial_viscosity.tex}
\input{chapters/linearization_in_time.tex}
\input{chapters/2d_regularization.tex}
%\input{chapters/2d_shallow_water_equations_gray.tex}
\end{document}