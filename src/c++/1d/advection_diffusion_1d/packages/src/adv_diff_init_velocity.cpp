...
void adv_diff_init_velocity(std::vector<double>& u, const double u_adv, const double g,  const std::vector<double>& zb, const std::vector<double>& x, SHAPE_CONC shape_conc)
{
    switch (shape_conc)
    {
