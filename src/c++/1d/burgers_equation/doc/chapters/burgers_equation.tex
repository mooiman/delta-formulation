...
%    \\*
%    & = \sqrt[3]{\frac{1}{3}}\left(  \frac{1}{8}\Dx^2 \pdiff[2]{\ubar}{x} \right) \approx
%    \\*
%    &\approx 0.69336 \times 0.125 \Dx^2 \pdiff[2]{\ubar}{x} = 0.08667 \Dx^2 \pdiff[2]{\ubar}{x}
%\end{align}
...
\begin{align}
    u^{n+1}_{bnd} &= f(t)
    \\
    u^{n+\theta, p}_{bnd} + \theta \Delta u_{bnd}  &= f(t)
    \\
    \theta \Delta u_{bnd} & = f(t) - u^{n+\theta, p}_{bnd}
\end{align}
with
\begin{align}
    \Delta u_{bnd} & =
     w^{\it ess}_0 \Delta u^{n+1,p+1}_0
+ w^{\it ess}_1 \Delta u^{n+1,p+1}_1
+ w^{\it ess}_2 \Delta u^{n+1,p+1}_2,
    \\
    u^{n+\theta, p}_{bnd} & =
