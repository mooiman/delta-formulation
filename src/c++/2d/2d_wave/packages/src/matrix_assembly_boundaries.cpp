    ...
    std::vector<double>& w_nat, std::vector<double>& w_ess)
{
    ...
    else
    {
        if (bc_type[BC_NORTH] == "mooiman")
        {
            ...
            set_value(values, col_wb , face_fac * 0.0 * theta * w_ess[0] * -c_wave);
            set_value(values, col_ws , face_fac * 0.0 * theta * w_ess[1] * -c_wave);
            set_value(values, col_wss, face_fac * 0.0 * theta * w_ess[2] * -c_wave);

            set_value(values, col_b , face_fac * 4.0 * theta * w_ess[0] * -c_wave);
            set_value(values, col_s , face_fac * 4.0 * theta * w_ess[1] * -c_wave);
            set_value(values, col_ss, face_fac * 4.0 * theta * w_ess[2] * -c_wave);
            ...
            set_value(values, col_eb , face_fac * 0.0 * theta * w_ess[0] * -c_wave);
            set_value(values, col_es , face_fac * 0.0 * theta * w_ess[1] * -c_wave);
            set_value(values, col_ess, face_fac * 0.0 * theta * w_ess[2] * -c_wave);
            ...
            // face 0
            face_fac = 0.5 * dx * 0.25;
            set_value(values, col_wb  + 2, face_fac * 0.0 * theta * w_ess[0]);
            set_value(values, col_ws  + 2, face_fac * 0.0 * theta * w_ess[1]);
            set_value(values, col_wss + 2, face_fac * 0.0 * theta * w_ess[2]);

            set_value(values, col_b  + 2, face_fac * 4.0 * theta * w_ess[0]);
            set_value(values, col_s  + 2, face_fac * 4.0 * theta * w_ess[1]);
            set_value(values, col_ss + 2, face_fac * 4.0 * theta * w_ess[2]);
            ...
            set_value(values, col_eb  + 2, face_fac * 0.0 * theta * w_ess[0]);
            set_value(values, col_es  + 2, face_fac * 0.0 * theta * w_ess[1]);
            set_value(values, col_ess + 2, face_fac * 0.0 * theta * w_ess[2]);
            //
            // Right hand side
            face_fac = 0.5;
            htheta_b   = 0.25 * (4.0 * htheta[p_5] + 0.0 * htheta[p_2]);
            htheta_jm1 = 0.25 * (4.0 * htheta[p_4] + 0.0 * htheta[p_1]);
            htheta_jm2 = 0.25 * (4.0 * htheta[p_3] + 0.0 * htheta[p_0]);
            double ht_jm12 = face_fac * ( w_ess[0] * htheta_b + w_ess[1] * htheta_jm1 + w_ess[2] * htheta_jm2);
            htheta_b   = 0.25 * (4.0 * htheta[p_5] + 0.0 * htheta[p_8]);
            htheta_jm1 = 0.25 * (4.0 * htheta[p_4] + 0.0 * htheta[p_7]);
            htheta_jm2 = 0.25 * (4.0 * htheta[p_3] + 0.0 * htheta[p_6]);
            ht_jm12 += face_fac * (w_ess[0] * htheta_b + w_ess[1] * htheta_jm1 + w_ess[2] * htheta_jm2);

            rtheta_b   = 0.25 * (4.0 * rtheta[p_5] + 0.0 * rtheta[p_2]);
            rtheta_jm1 = 0.25 * (4.0 * rtheta[p_4] + 0.0 * rtheta[p_1]);
            rtheta_jm2 = 0.25 * (4.0 * rtheta[p_3] + 0.0 * rtheta[p_0]);
            double rt_jm12 = face_fac * (w_ess[0] * rtheta_b + w_ess[1] * rtheta_jm1 + w_ess[2] * rtheta_jm2);
            rtheta_b   = 0.25 * (4.0 * rtheta[p_5] + 0.0 * rtheta[p_8]);
            rtheta_jm1 = 0.25 * (4.0 * rtheta[p_4] + 0.0 * rtheta[p_7]);
            rtheta_jm2 = 0.25 * (4.0 * rtheta[p_3] + 0.0 * rtheta[p_6]);
    ...
    std::vector<double>& w_nat, std::vector<double>& w_ess)
{
    ...
    else
    {
        if (bc_type[BC_EAST] == "mooiman")
        {
            ...
            set_value(values, col_nb , face_fac * 0.0 * theta * w_ess[0] * -c_wave);
            set_value(values, col_nw , face_fac * 0.0 * theta * w_ess[1] * -c_wave);
            set_value(values, col_nww, face_fac * 0.0 * theta * w_ess[2] * -c_wave);
            
            set_value(values, col_b , face_fac * 4.0 * theta * w_ess[0] * -c_wave);
            set_value(values, col_w , face_fac * 4.0 * theta * w_ess[1] * -c_wave);
            set_value(values, col_ww, face_fac * 4.0 * theta * w_ess[2] * -c_wave);
            ...
            set_value(values, col_sb , face_fac * 0.0 * theta * w_ess[0] * -c_wave);
            set_value(values, col_sw , face_fac * 0.0 * theta * w_ess[1] * -c_wave);
            set_value(values, col_sww, face_fac * 0.0 * theta * w_ess[2] * -c_wave);
            
            // Contribution Delta q
            // face 0
            face_fac = 0.5 * dy * 0.25;
            set_value(values, col_nb  + 1, face_fac * 0.0 * theta * w_ess[0]);
            set_value(values, col_nw  + 1, face_fac * 0.0 * theta * w_ess[1]);
            set_value(values, col_nww + 1, face_fac * 0.0 * theta * w_ess[2]);

            set_value(values, col_b  + 1, face_fac * 4.0 * theta * w_ess[0]);
            set_value(values, col_w  + 1, face_fac * 4.0 * theta * w_ess[1]);
            set_value(values, col_ww + 1, face_fac * 4.0 * theta * w_ess[2]);
            ...
            set_value(values, col_sb  + 1, face_fac * 0.0 * theta * w_ess[0]);
            set_value(values, col_sw  + 1, face_fac * 0.0 * theta * w_ess[1]);
            set_value(values, col_sww + 1, face_fac * 0.0 * theta * w_ess[2]);
            ...
            // Right hand side
            face_fac = 0.5;
            htheta_b   = 0.25 * (4.0 * htheta[p_7] + 0.0 * htheta[p_8]);
            htheta_im1 = 0.25 * (4.0 * htheta[p_4] + 0.0 * htheta[p_5]);
            htheta_im2 = 0.25 * (4.0 * htheta[p_1] + 0.0 * htheta[p_2]);
            double ht_im12 = face_fac * (w_ess[0] * htheta_b + w_ess[1] * htheta_im1 + w_ess[2] * htheta_im2);
            htheta_b   = 0.25 * (4.0 * htheta[p_7] + 0.0 * htheta[p_6]);
            htheta_im1 = 0.25 * (4.0 * htheta[p_4] + 0.0 * htheta[p_3]);
            htheta_im2 = 0.25 * (4.0 * htheta[p_1] + 0.0 * htheta[p_0]);
            ht_im12 += face_fac * (w_ess[0] * htheta_b + w_ess[1] * htheta_im1 + w_ess[2] * htheta_im2);
            
            qtheta_b   = 0.25 * (4.0 * qtheta[p_7] + 0.0 * qtheta[p_8]);
            qtheta_im1 = 0.25 * (4.0 * qtheta[p_4] + 0.0 * qtheta[p_5]);
            qtheta_im2 = 0.25 * (4.0 * qtheta[p_1] + 0.0 * qtheta[p_2]);
            double qt_im12 = face_fac * (w_ess[0] * qtheta_b + w_ess[1] * qtheta_im1 + w_ess[2] * qtheta_im2);
            qtheta_b   = 0.25 * (4.0 * qtheta[p_7] + 0.0 * qtheta[p_6]);
            qtheta_im1 = 0.25 * (4.0 * qtheta[p_4] + 0.0 * qtheta[p_3]);
            qtheta_im2 = 0.25 * (4.0 * qtheta[p_1] + 0.0 * qtheta[p_0]);
    ...
    std::vector<double>& w_nat, std::vector<double>& w_ess)
{
    ...
    else
    {
        if (bc_type[BC_SOUTH] == "mooiman")
        {
            ...
            double face_fac = 0.5 * dx * 0.25;
            set_value(values, col_wb , face_fac * 0.0 * theta * w_ess[0] * c_wave);
            set_value(values, col_wn , face_fac * 0.0 * theta * w_ess[1] * c_wave);
            set_value(values, col_wnn, face_fac * 0.0 * theta * w_ess[2] * c_wave);

            set_value(values, col_b , face_fac * 4.0 * theta * w_ess[0] * c_wave);
            set_value(values, col_n , face_fac * 4.0 * theta * w_ess[1] * c_wave);
            set_value(values, col_nn, face_fac * 4.0 * theta * w_ess[2] * c_wave);
            ...
            set_value(values, col_eb , face_fac * 0.0 * theta * w_ess[0] * c_wave);
            set_value(values, col_en , face_fac * 0.0 * theta * w_ess[1] * c_wave);
            set_value(values, col_enn, face_fac * 0.0 * theta * w_ess[2] * c_wave);
            ...
            face_fac = 0.5 * dx * 0.25;
            set_value(values, col_wb  + 2, face_fac * 0.0 * theta * w_ess[0]);
            set_value(values, col_wn  + 2, face_fac * 0.0 * theta * w_ess[1]);
            set_value(values, col_wnn + 2, face_fac * 0.0 * theta * w_ess[2]);

            set_value(values, col_b  + 2, face_fac * 4.0 * theta * w_ess[0]);
            set_value(values, col_n  + 2, face_fac * 4.0 * theta * w_ess[1]);
            set_value(values, col_nn + 2, face_fac * 4.0 * theta * w_ess[2]);
            ...
            set_value(values, col_eb  + 2, face_fac * 0.0 * theta * w_ess[0]);
            set_value(values, col_en  + 2, face_fac * 0.0 * theta * w_ess[1]);
            set_value(values, col_enn + 2, face_fac * 0.0 * theta * w_ess[2]);
            //
            // Right hand side
            face_fac = 0.5;
            htheta_b   = 0.25 * (4.0 * htheta[p_3] + 0.0 * htheta[p_0]);
            htheta_jp1 = 0.25 * (4.0 * htheta[p_4] + 0.0 * htheta[p_1]);
            htheta_jp2 = 0.25 * (4.0 * htheta[p_5] + 0.0 * htheta[p_2]);
            double ht_jp12 = face_fac *  (w_ess[0] * htheta_b + w_ess[1] * htheta_jp1 + w_ess[2] * htheta_jp2);
            htheta_b   = 0.25 * (4.0 * htheta[p_3] + 0.0 * htheta[p_6]);
            htheta_jp1 = 0.25 * (4.0 * htheta[p_4] + 0.0 * htheta[p_7]);
            htheta_jp2 = 0.25 * (4.0 * htheta[p_5] + 0.0 * htheta[p_8]);
            ht_jp12 += face_fac * (w_ess[0] * htheta_b + w_ess[1] * htheta_jp1 + w_ess[2] * htheta_jp2);

            rtheta_b   = 0.25 * (4.0 * rtheta[p_3] + 0.0 * rtheta[p_0]);
            rtheta_jp1 = 0.25 * (4.0 * rtheta[p_4] + 0.0 * rtheta[p_1]);
            rtheta_jp2 = 0.25 * (4.0 * rtheta[p_5] + 0.0 * rtheta[p_2]);
            double rt_jp12 = face_fac * (w_ess[0] * rtheta_b + w_ess[1] * rtheta_jp1 + w_ess[2] * rtheta_jp2);
            rtheta_b   = 0.25 * (4.0 * rtheta[p_3] + 0.0 * rtheta[p_6]);
            rtheta_jp1 = 0.25 * (4.0 * rtheta[p_4] + 0.0 * rtheta[p_7]);
            rtheta_jp2 = 0.25 * (4.0 * rtheta[p_5] + 0.0 * rtheta[p_8]);
    ...
    std::vector<double>& w_nat, std::vector<double>& w_ess)
{
    ...
    else
    {
        if (bc_type[BC_WEST] == "mooiman")
        {
            ...
            double face_fac = 0.5 * dy * 0.25;
            set_value(values, col_sb , face_fac * 0.0 * theta * w_ess[0] * c_wave);
            set_value(values, col_se , face_fac * 0.0 * theta * w_ess[1] * c_wave);
            set_value(values, col_see, face_fac * 0.0 * theta * w_ess[2] * c_wave);
            
            set_value(values, col_b , face_fac * 4.0 * theta * w_ess[0] * c_wave);
            set_value(values, col_e , face_fac * 4.0 * theta * w_ess[1] * c_wave);
            set_value(values, col_ee, face_fac * 4.0 * theta * w_ess[2] * c_wave);
            ...
            set_value(values, col_nb , face_fac * 0.0 * theta * w_ess[0] * c_wave);
            set_value(values, col_ne , face_fac * 0.0 * theta * w_ess[1] * c_wave);
            set_value(values, col_nee, face_fac * 0.0 * theta * w_ess[2] * c_wave);
            
            // Contribution Delta q
            // face 0
            face_fac = 0.5 * dy * 0.25;
            set_value(values, col_sb  + 1, face_fac * 0.0 * theta * w_ess[0]);
            set_value(values, col_se  + 1, face_fac * 0.0 * theta * w_ess[1]);
            set_value(values, col_see + 1, face_fac * 0.0 * theta * w_ess[2]);

            set_value(values, col_b  + 1, face_fac * 4.0 * theta * w_ess[0]);
            set_value(values, col_e  + 1, face_fac * 4.0 * theta * w_ess[1]);
            set_value(values, col_ee + 1, face_fac * 4.0 * theta * w_ess[2]);
            ...
            set_value(values, col_nb  + 1, face_fac * 0.0 * theta * w_ess[0]);
            set_value(values, col_ne  + 1, face_fac * 0.0 * theta * w_ess[1]);
            set_value(values, col_nee + 1, face_fac * 0.0 * theta * w_ess[2]);
            ...
            // Right hand side
            face_fac = 0.5;
            htheta_b   = 0.25 * (4.0 * htheta[p_1] + 0.0 * htheta[p_2]);
            htheta_ip1 = 0.25 * (4.0 * htheta[p_4] + 0.0 * htheta[p_5]);
            htheta_ip2 = 0.25 * (4.0 * htheta[p_7] + 0.0 * htheta[p_8]);
            double ht_ip12 = face_fac * (w_ess[0] * htheta_b + w_ess[1] * htheta_ip1 + w_ess[2] * htheta_ip2);
            htheta_b   = 0.25 * (4.0 * htheta[p_1] + 0.0 * htheta[p_0]);
            htheta_ip1 = 0.25 * (4.0 * htheta[p_4] + 0.0 * htheta[p_3]);
            htheta_ip2 = 0.25 * (4.0 * htheta[p_7] + 0.0 * htheta[p_7]);            
            ht_ip12 += face_fac * (w_ess[0] * htheta_b + w_ess[1] * htheta_ip1 + w_ess[2] * htheta_ip2);

            qtheta_b   = 0.25 * (4.0 * qtheta[p_1] + 0.0 * qtheta[p_2]);
            qtheta_ip1 = 0.25 * (4.0 * qtheta[p_4] + 0.0 * qtheta[p_5]);
            qtheta_ip2 = 0.25 * (4.0 * qtheta[p_7] + 0.0 * qtheta[p_8]);
            double qt_ip12 = face_fac * (w_ess[0] * qtheta_b + w_ess[1] * qtheta_ip1 + w_ess[2] * qtheta_ip2);
            qtheta_b   = 0.25 * (4.0 * qtheta[p_1] + 0.0 * qtheta[p_0]);
            qtheta_ip1 = 0.25 * (4.0 * qtheta[p_4] + 0.0 * qtheta[p_3]);
            qtheta_ip2 = 0.25 * (4.0 * qtheta[p_7] + 0.0 * qtheta[p_6]);
