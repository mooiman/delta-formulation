    ...
    std::vector<double>& visc_11, std::vector<double>& visc_22, double theta, size_t nx, size_t ny)
{
    ...
    //double cv_area_0 = scv_area[0] + scv_area[1] + scv_area[2] + scv_area[3];
    //double cv_area_1 = scv_area[0] + scv_area[1] + scv_area[2] + scv_area[3];
    //double cv_area_2 = scv_area[0] + scv_area[1] + scv_area[2] + scv_area[3];
    //double cv_area_3 = scv_area[0] + scv_area[1] + scv_area[2] + scv_area[3];
...
//==============================================================================
    ...
    double aa_q = visc_1 / scv_area[0] * qtheta_0 /(htheta_0 * htheta_0) * dh_dxi;
    double bb_q = visc_1 / scv_area[0] * -1./ htheta_0 * dh_dxi;
    double cc_q = visc_1 / scv_area[0] * 1.0;
    double dd_q = visc_1 / scv_area[0] * - qtheta_0 / htheta_0;

    double aa_r = visc_1 / scv_area[0] * rtheta_0 / (htheta_0 * htheta_0) * dh_dxi;
    double bb_r = visc_1 / scv_area[0] * -1.0 / htheta_0 * dh_dxi;
    double cc_r = visc_1 / scv_area[0] * 1.0;
    double dd_r = visc_1 / scv_area[0] * - rtheta_0 / htheta_0;
    ...
    aa_q = visc_1 / scv_area[0] * qtheta_0 /(htheta_0 * htheta_0) * dh_deta;
    bb_q = visc_1 / scv_area[0] * -1./ htheta_0 * dh_deta;
    cc_q = visc_1 / scv_area[0] * 1.0;
    dd_q = visc_1 / scv_area[0] * - qtheta_0 / htheta_0;

    aa_r = visc_1 / scv_area[0] * rtheta_0 / (htheta_0 * htheta_0) * dh_dxi;
    bb_r = visc_1 / scv_area[0] * -1.0 / htheta_0 * dh_dxi;
    cc_r = visc_1 / scv_area[0] * 1.0;
    dd_r = visc_1 / scv_area[0] * - rtheta_0 / htheta_0;
    ...
    aa_q = visc_1 / scv_area[1] * qtheta_0 /(htheta_0 * htheta_0) * dh_deta;
    bb_q = visc_1 / scv_area[1] * -1./ htheta_0 * dh_deta;
    cc_q = visc_1 / scv_area[1] * 1.0;
    dd_q = visc_1 / scv_area[1] * - qtheta_0 / htheta_0;

    aa_r = visc_1 / scv_area[1] * rtheta_0 / (htheta_0 * htheta_0) * dh_dxi;
    bb_r = visc_1 / scv_area[1] * -1.0 / htheta_0 * dh_dxi;
    cc_r = visc_1 / scv_area[1] * 1.0;
    dd_r = visc_1 / scv_area[1] * - rtheta_0 / htheta_0;
    ...
    aa_q = visc_1 / scv_area[1] * qtheta_0 /(htheta_0 * htheta_0) * dh_dxi;
    bb_q = visc_1 / scv_area[1] * -1./ htheta_0 * dh_dxi;
    cc_q = visc_1 / scv_area[1] * 1.0;
    dd_q = visc_1 / scv_area[1] * - qtheta_0 / htheta_0;
    ...
    aa_q = visc_1 / scv_area[2] * qtheta_0 /(htheta_0 * htheta_0) * dh_dxi;
    bb_q = visc_1 / scv_area[2] * -1./ htheta_0 * dh_dxi;
    cc_q = visc_1 / scv_area[2] * 1.0;
    dd_q = visc_1 / scv_area[2] * - qtheta_0 / htheta_0;

    aa_r = visc_1 / scv_area[2] * rtheta_0 / (htheta_0 * htheta_0) * dh_dxi;
    bb_r = visc_1 / scv_area[2] * -1.0 / htheta_0 * dh_dxi;
    cc_r = visc_1 / scv_area[2] * 1.0;
    dd_r = visc_1 / scv_area[2] * - rtheta_0 / htheta_0;
    ...
    aa_q = visc_1 / scv_area[2] * qtheta_0 /(htheta_0 * htheta_0) * dh_deta;
    bb_q = visc_1 / scv_area[2] * -1./ htheta_0 * dh_deta;
    cc_q = visc_1 / scv_area[2] * 1.0;
    dd_q = visc_1 / scv_area[2] * - qtheta_0 / htheta_0;
    ...
    aa_q = visc_1 / scv_area[3] * qtheta_0 /(htheta_0 * htheta_0) * dh_deta;
    bb_q = visc_1 / scv_area[3] * -1./ htheta_0 * dh_deta;
    cc_q = visc_1 / scv_area[3] * 1.0;
    dd_q = visc_1 / scv_area[3] * - qtheta_0 / htheta_0;

    aa_r = visc_1 / scv_area[3] * rtheta_0 / (htheta_0 * htheta_0) * dh_dxi;
    bb_r = visc_1 / scv_area[3] * -1.0 / htheta_0 * dh_dxi;
    cc_r = visc_1 / scv_area[3] * 1.0;
    dd_r = visc_1 / scv_area[3] * - rtheta_0 / htheta_0;
    ...
    aa_q = visc_1 / scv_area[3] * qtheta_0 /(htheta_0 * htheta_0) * dh_dxi;
    bb_q = visc_1 / scv_area[3] * -1./ htheta_0 * dh_dxi;
    cc_q = visc_1 / scv_area[3] * 1.0;
    dd_q = visc_1 / scv_area[3] * - qtheta_0 / htheta_0;
...
//==============================================================================
    ...
    double aa_q = visc_2 / scv_area[0] * qtheta_0 / (htheta_0 * htheta_0) * dh_deta;
    double bb_q = visc_2 / scv_area[0] * -1.0 / htheta_0 * dh_deta;
    double cc_q = visc_2 / scv_area[0] * 1.0;
    double dd_q = visc_2 / scv_area[0] * - qtheta_0 / htheta_0;

    double aa_r = visc_2 / scv_area[0] * rtheta_0 / (htheta_0 * htheta_0) * dh_dxi;
    double bb_r = visc_2 / scv_area[0] * -1.0 / htheta_0 * dh_dxi;
    double cc_r = visc_2 / scv_area[0] * 1.0;
    double dd_r = visc_2 / scv_area[0] * - rtheta_0 / htheta_0;
    ...
    aa_q = visc_2 / scv_area[0] * qtheta_0 / (htheta_0 * htheta_0) * dh_deta;
    bb_q = visc_2 / scv_area[0] * -1.0 / htheta_0 * dh_deta;
    cc_q = visc_2 / scv_area[0] * 1.0;
    dd_q = visc_2 / scv_area[0] * - qtheta_0 / htheta_0;

    aa_r = visc_2 / scv_area[0] * rtheta_0 / (htheta_0 * htheta_0) * dh_deta;
    bb_r = visc_2 / scv_area[0] * -1.0 / htheta_0 * dh_deta;
    cc_r = visc_2 / scv_area[0] * 1.0;
    dd_r = visc_2 / scv_area[0] * - rtheta_0 / htheta_0;
    ...
    aa_q = visc_2 / scv_area[1] * qtheta_0 / (htheta_0 * htheta_0) * dh_deta;
    bb_q = visc_2 / scv_area[1] * -1.0 / htheta_0 * dh_deta;
    cc_q = visc_2 / scv_area[1] * 1.0;
    dd_q = visc_2 / scv_area[1] * - qtheta_0 / htheta_0;

    aa_r = visc_2 / scv_area[1] * rtheta_0 / (htheta_0 * htheta_0) * dh_deta;
    bb_r = visc_2 / scv_area[1] * -1.0 / htheta_0 * dh_deta;
    cc_r = visc_2 / scv_area[1] * 1.0;
    dd_r = visc_2 / scv_area[1] * - rtheta_0 / htheta_0;
    ...
    aa_r = visc_2 / scv_area[1] * rtheta_0 / (htheta_0 * htheta_0) * dh_dxi;
    bb_r = visc_2 / scv_area[1] * -1.0 / htheta_0 * dh_dxi;
    cc_r = visc_2 / scv_area[1] * 1.0;
    dd_r = visc_2 / scv_area[1] * - rtheta_0 / htheta_0;
    ...
    aa_q = visc_2 / scv_area[2] * qtheta_0 / (htheta_0 * htheta_0) * dh_deta;
    bb_q = visc_2 / scv_area[2] * -1.0 / htheta_0 * dh_deta;
    cc_q = visc_2 / scv_area[2] * 1.0;
    dd_q = visc_2 / scv_area[2] * - qtheta_0 / htheta_0;

    aa_r = visc_2 / scv_area[2] * rtheta_0 / (htheta_0 * htheta_0) * dh_dxi;
    bb_r = visc_2 / scv_area[2] * -1.0 / htheta_0 * dh_dxi;
    cc_r = visc_2 / scv_area[2] * 1.0;
    dd_r = visc_2 / scv_area[2] * - rtheta_0 / htheta_0;
    ...
    aa_r = visc_2 / scv_area[2] * rtheta_0 / (htheta_0 * htheta_0) * dh_deta;
    bb_r = visc_2 / scv_area[2] * -1.0 / htheta_0 * dh_deta;
    cc_r = visc_2 / scv_area[2] * 1.0;
    dd_r = visc_2 / scv_area[2] * - rtheta_0 / htheta_0;
    ...
    aa_q = visc_2 / scv_area[3] * qtheta_0 / (htheta_0 * htheta_0) * dh_deta;
    bb_q = visc_2 / scv_area[3] * -1.0 / htheta_0 * dh_deta;
    cc_q = visc_2 / scv_area[3] * 1.0;
    dd_q = visc_2 / scv_area[3] * - qtheta_0 / htheta_0;

    aa_r = visc_2 / scv_area[3] * rtheta_0 / (htheta_0 * htheta_0) * dh_deta;
    bb_r = visc_2 / scv_area[3] * -1.0 / htheta_0 * dh_deta;
    cc_r = visc_2 / scv_area[3] * 1.0;
    dd_r = visc_2 / scv_area[3] * - rtheta_0 / htheta_0;
    ...
    aa_r = visc_2 / scv_area[3] * rtheta_0 / (htheta_0 * htheta_0) * dh_dxi;
    bb_r = visc_2 / scv_area[3] * -1.0 / htheta_0 * dh_dxi;
    cc_r = visc_2 / scv_area[3] * 1.0;
    dd_r = visc_2 / scv_area[3] * - rtheta_0 / htheta_0;
...
//==============================================================================
            ...
            aa_q = visc_2 / scv_area[0] * qtheta_0 /(htheta_0 * htheta_0) * dh_deta;
            bb_q = visc_2 / scv_area[0] * -1./ htheta_0 * dh_deta;
            cc_q = visc_2 / scv_area[0] * 1.0;
            dd_q = visc_2 / scv_area[0] * - qtheta_0 / htheta_0;

            aa_r = visc_2 / scv_area[0] * rtheta_0 / (htheta_0 * htheta_0) * dh_dxi;
            bb_r = visc_2 / scv_area[0] * -1.0 / htheta_0 * dh_dxi;
            cc_r = visc_2 / scv_area[0] * 1.0;
            dd_r = visc_2 / scv_area[0] * - rtheta_0 / htheta_0;
            ...
            aa_q = visc_2 / scv_area[1] * qtheta_0 /(htheta_0 * htheta_0) * dh_deta;
            bb_q = visc_2 / scv_area[1] * -1./ htheta_0 * dh_deta;
            cc_q = visc_2 / scv_area[1] * 1.0;
            dd_q = visc_2 / scv_area[1] * - qtheta_0 / htheta_0;
            ...
            aa_q = visc_2 / scv_area[2] * qtheta_0 /(htheta_0 * htheta_0) * dh_deta;
            bb_q = visc_2 / scv_area[2] * -1./ htheta_0 * dh_deta;
            cc_q = visc_2 / scv_area[2] * 1.0;
            dd_q = visc_2 / scv_area[2] * - qtheta_0 / htheta_0;
            ...
            aa_q = visc_2 / scv_area[3] * qtheta_0 /(htheta_0 * htheta_0) * dh_deta;
            bb_q = visc_2 / scv_area[3] * -1./ htheta_0 * dh_deta;
            cc_q = visc_2 / scv_area[3] * 1.0;
            dd_q = visc_2 / scv_area[3] * - qtheta_0 / htheta_0;
