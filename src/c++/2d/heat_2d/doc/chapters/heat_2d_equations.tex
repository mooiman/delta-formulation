...
\begin{align}
    &\frac{1}{J} \Bigg[
      y_\eta \pdiff{}{\xi} \left(  \Psi_{11} \left( y_\eta \pdiff{u}{\xi}
    - y_\xi  \pdiff{u}{\eta}\right) + \Psi_{12} \left( - x_\eta \pdiff{u}{\xi} + x_\xi \pdiff{u}{\eta} \right) \right) +
    \\
    &\qquad - y_\xi \pdiff{}{\eta} \left(  \Psi_{11} \left(y_\eta \pdiff{u}{\xi}  - y_\xi \pdiff{u}{\eta} \right) + \Psi_{12} \left( -x_\eta \pdiff{u}{\xi} + x_\xi \pdiff{u}{\eta} \right) \right) \Bigg] +
    \\*
    +
    &\frac{1}{J} \Bigg[
    -x_\eta \pdiff{}{\xi} \left(  \Psi_{21} \left( y_\eta \pdiff{u}{\xi} - y_\xi \pdiff{u}{\eta} \right) + \Psi_{22} \left( -x_\eta \pdiff{u}{\xi} + x_\xi \pdiff{u}{\eta} \right)  \right) +
    \\
    &\qquad + x_\xi \pdiff{}{\eta} \left( \Psi_{21} \left( y_\eta \pdiff{u}{\xi}  - y_\xi \pdiff{u}{\eta} \right) + \Psi_{22} \left( -x_\eta \pdiff{u}{\xi} + x_\xi \pdiff{u}{\eta} \right)   \right)
    \Bigg]
\end{align}
\begin{align}
    &\frac{1}{J} \Bigg[
