...
\begin{align}
    ...
    \Bigg]
\end{align}
\textit{step 2a}: Applying Green's theorem, and multiplying with $J$
\begin{align}
    &
...
\begin{align}
    &
    \Bigg[ y_\eta
    \Psi \left( y_\eta \pdiff{u}{\xi} - y_\xi  \pdiff{u}{\eta}\right)
     - x_\eta
    \Psi \left( - x_\eta \pdiff{u}{\xi} + x_\xi \pdiff{u}{\eta} \right)
    \Bigg] \nxi
    +
    \\
    &\Bigg[
