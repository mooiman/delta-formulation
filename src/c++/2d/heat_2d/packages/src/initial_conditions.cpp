        ...
        for (size_t i = 0; i < nx; i++)
        {
            for (size_t j = 0; j < ny; j++)
            {
                ...
                else
                {
                    ...
                    std::cout << "Option: " << ini_vars[0] << "\' is not supported to intialize the water level ." << std::endl;
